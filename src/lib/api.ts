...
export const callRefineTask = async (data: RefineRequest): Promise<RefineResponse> => {
    const prompts: Record<TaskMode, string> = {
    ...
    const systemPrompt = prompts[data.mode] || "Process the following input.";
